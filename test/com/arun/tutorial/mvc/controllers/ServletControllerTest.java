...
public class ServletControllerTest {
	...
	private ServletController servletController = new ServletController();
...
//		when(request.getParameter("mail")).thenReturn("Arun@gmail.com");
	...
	@Test
	public void shouldForwardToInitialJSP() throws ServletException, IOException{
		HttpServletRequest stubRequest = new StubkHttpServletRequest();
		HttpServletResponse stubResponse = new StubHttpServletResponse();
	...
	private class StubkHttpServletRequest implements HttpServletRequest {
